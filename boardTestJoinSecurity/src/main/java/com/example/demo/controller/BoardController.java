...
public class BoardController {
	...
	public void insertForm(Model model,@RequestParam (defaultValue="0") int p_no, HttpSession session) {
...
//				fos.close();
	...
	public ModelAndView list(@PathVariable int i, @PathVariable String id, HttpSession session) {
		...
		session.setAttribute("user",mdao.findById(loginId).get());

...
//	@Query("select b from Board b order by b.b_ref desc, b.b_step asc")
	...
	//insert into Board b(b.no,b.title,b.writer,b.pwd,b.content,b.regdate,
	//b.hit,b.ip,b.b_ref,b.b_step,b.b_level,b.fname) values(:#{#b.no},:#{#b.title},:#{#b.writer},:#{#b.pwd},:#{#b.content},sysdate,0,
	//:#{#b.ip},:#{#b.b_ref},:#{#b.b_step},:#{#b.b_level},:#{#b.fname})
	@Modifying
